                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="/login">
                            ...
                            <div class="form-control mt-4">
                                <label class="label cursor-pointer justify-content-start">
                        ...
                        <!-- OAuth Buttons -->
                        <div class="space-y-3">
                            <a href="{{ route('oauth.google') }}" class="btn btn-outline btn-block">
                            ...
                            <a href="{{ route('oauth.github') }}" class="btn btn-outline btn-block">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
